...
<template>
  <div>
    ...
    <div>
      <div>
        <input type="radio" value="1" :model-value="searchQuery"
      @update:model-value="setSearchQuery">
        <label>По названию</label>
      </div>
      <div>
        <input type="radio" value="2" :model-value="searchQuery"
      @update:model-value="setSearchQuery">
        <label>По тегу</label>
      </div>
      <div>
        <input type="radio" value="3" :model-value="searchQuery"
      @update:model-value="setSearchQuery">
        <label>По автору</label>
      </div>
      <div>
        <input type="radio" value="4" :model-value="searchQuery"
      @update:model-value="setSearchQuery">
