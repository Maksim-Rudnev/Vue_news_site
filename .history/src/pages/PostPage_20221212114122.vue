...
<template>
  <div>
    ...
    <div>
      <div>
        <input type="radio" value="1" v-model="selectedSearch">
        <label>По названию</label>
      </div>
      <div>
        <input type="radio" value="2" v-model="selectedSearch">
        <label>По тегу</label>
      </div>
      <div>
        <input type="radio" value="3" v-model="selectedSearch">
        <label>По автору</label>
      </div>
      <div>
        <input type="radio" value="4" v-model="selectedSearch">
...
export default {
  ...
  methods: {
    ...mapMutations({
      ...
      setSelectedSearch: 'post/setSelectedSort',
    }),
    ...mapActions({
