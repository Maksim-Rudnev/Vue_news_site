<template>
  <div class="navbar">
    ...
    <div class="right-panel">
      <my-button v-if="!isAuth" @click="signVisible = true, setSignUp(true)">
      Регистрация
    </my-button>
    ...
    <my-button v-if="!isAuth" @click="signVisible = true, setSignUp(false)">
      Войти
    </my-button>
  ...
  <my-dialog
      v-model:show="signVisible"
      @update:show="signVisible"
    >
      <my-auth></my-auth>
    </my-dialog>
</template>
