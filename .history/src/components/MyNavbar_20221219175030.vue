<template>
  <div class="navbar">
    ...
    <div class="right-panel">
      <my-button v-if="!isAuth" @click="setSignVisible(true), setSignUp(true)">
      Регистрация
    </my-button>
    ...
    <my-button v-if="!isAuth" @click="setSignVisible(true), setSignUp(false)">
      Войти
    </my-button>
...
export default {
  ...
  methods: {
    ...mapMutations({
      setSignVisible: 'auth/setSignVisible',
  ...
  computed: {
    ...mapState({
      ...
      signVisible: (state) => state.auth.signVisible,
    }),
  },
  beforeMount() {
    this.whoAmI();
