<template>
  <div class="navbar">
    ...
    <div class="right-panel">
      <my-button v-if="!isAuth" @click="setDialogSignVisible(true), setSignUp(true)">
      Регистрация
    </my-button>
    ...
    <my-button v-if="!isAuth" @click="setDialogSignVisible(true), setSignUp(false)">
      Войти
    </my-button>
  ...
  <my-dialog
      :show="signVisible"
      @update:show="setDialogSignVisible"
    >
      <my-auth></my-auth>
    </my-dialog>
</template>
...
export default {
  ...
  data() {
    return signVisible: false,
  }
  methods: {
    ...mapMutations({
      setDialogSignVisible: 'dialog/setDialogSignVisible',
  ...
  computed: {
    ...mapState({
      ...
      signVisible: (state) => state.dialog.signVisible,
    }),
  },
  beforeMount() {
    this.whoAmI();
