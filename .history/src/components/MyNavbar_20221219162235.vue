<template>
  <div class="navbar">
    ...
    <div class="right-panel">
      <my-button v-if="!isAuth" @click="setDialogSignInVisible(true), setSignUp(true)">
      Регистрация
    </my-button>
    ...
    <my-button v-if="!isAuth" @click="setDialogSignInVisible(true), setSignUp(false)">
      Войти
    </my-button>
  ...
  <my-dialog
      :show="signInVisible"
      @update:show="setDialogSignInVisible"
    >
      <my-auth></my-auth>
    </my-dialog>
</template>
...
export default {
  ...
  methods: {
    ...mapMutations({
      setDialogSignInVisible: 'dialog/setDialogSignInVisible',
  ...
  computed: {
    ...mapState({
      ...
      signInVisible: (state) => state.dialog.signInVisible,
    }),
  },
  beforeMount() {
    this.whoAmI();
